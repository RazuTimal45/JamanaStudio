...
class ServiceController extends BackendBaseController
{
    ...
    protected $base_view = 'backend.services.';
    protected $model;
    ...
    public function store(ServiceRequest $request)
    {
        try{
            ...
            if ($request->hasFile('image_file')) {
                ...
                $image->move('images/services/', $imageFilename);
    ...
    public function update(ServiceRequest $request, string $id)
    {
        ...
        if($request->hasfile('image_file')) {
            ...
            $request->file('image_file')->move('images/services/', $filename);
            $request->request->add(['image' => $filename]);
            if ($data['records']->image && file_exists(public_path('images/services/' . $data['records']->image))) {
                unlink(public_path('images/services/' . $data['records']->image));
            }
        }
